...
const AdminDashboard = () => {
  ...
  return (
    <div className="flex flex-col w-full gap-10">
      <div
        className={`h-[50px] rounded-md flex px-5 items-center justify-between z-10
      ...
      <div className="text-xl sm:text-2xl font-bold flex justify-center">
        Dashboard
      </div>
      ...
      <div className="w-full flex flex-col sm:flex-row flex-wrap items-center gap-4 justify-center">
